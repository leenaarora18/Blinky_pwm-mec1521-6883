...
extern __weak ALIAS_OF(no_handler) void * const z_impl_pwm_set_cycles;
extern __weak ALIAS_OF(no_handler) void * const z_impl_pwm_get_cycles_per_sec;
extern __weak ALIAS_OF(no_handler) void * const z_impl_pwm_enable_capture;
extern __weak ALIAS_OF(no_handler) void * const z_impl_pwm_disable_capture;
extern __weak ALIAS_OF(no_handler) void * const z_impl_pwm_capture_cycles;
